...
#define STRING_CONFIG_H_AUTHOR "Kristian Sloth Lauszus" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lauszus's Prusa i3"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 4000, 174.2}
